...
$(document).ready(function(){
    // $("div.thumb li img").on('mouseenter',function(){
    //   var imgTit = $(this).attr('title');
    //   var imgAlt = $(this).attr('alt');
    //   var imgUrl = "url(" + $(this).attr('data-url') + ")";
    //
    //   $('h1.house_title > span').text(imgTit);
    //   $('h1.house_title').text(imgAlt);
    //   $('.window_box').css('background-image',imgUrl);
    // });
    // $("div.thumb li img").on('mouseleave',function(){
    //   $('h1.house_title').text("Select Portfolio!");
    //   $('.window_box').css('background-image',"url('images/house_me_2.png')");
    // });

    // $(".tap > li div ul li img").on('mouseenter',function(){
    //   // var imgSrc = $(this).attr('src');
    //   var imgHov = $(this).attr('data-url');
    //   $(this).attr('src',imgHov);
    // });
    // $(".tap > li div ul li img").on('mouseleave',function(){
    //   var imgSrc = $(this).attr('data-url-default');
   ...
   $(".portfolio_box .art ul li div.imgBox .slider_btn").click(function(){
     var data_view = $(this).parents("img").attr('data-view')
